...
class function TMessagerHelper.sendMessage(msg: Cardinal; param: Cardinal): DWORD;
begin
  Result := Winapi.Windows.SendMessage(applicationHandle, WM_FORDREAM, msg, param);
end;
...
class function TMessagerHelper.postMessage(msg: Cardinal; param: Cardinal): BOOL;
begin
  Result := Winapi.Windows.PostMessage(applicationHandle, WM_FORDREAM, msg, param);
end;
